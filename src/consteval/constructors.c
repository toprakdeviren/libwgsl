/**
 * @file constructors.c — const-expression evaluator module.
 */
    ...
    WGSLValue *out)
{
    ...
    default:
        cev_error_kind(cev, WGSL_CEV_NOT_IMPLEMENTED, call,
            "constructor cannot be evaluated in a const expression");
        return 0;
    }
}

int append_inferred_component(
...
int eval_inferred_vector_constructor(
...
int eval_inferred_matrix_constructor(
...
int eval_inferred_array_constructor(
...
int eval_inferred_typegen_constructor(
    WGSLConstEvaluator *cev, WGSLNode *call, WGSLValue *out)
{
